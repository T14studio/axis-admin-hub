...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email input with an invalid email, fill the password, then submit the form to verify client-side email validation.
        ...
        await asyncio.sleep(3); await elem.fill('any-password')
